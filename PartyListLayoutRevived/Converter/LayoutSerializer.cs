...
namespace PartyListLayoutRevived.Converter {
    public static class LayoutSerializer {
        ...
        public static byte[] SerializeLayout(LayoutConfig layoutConfig) {
            ...
            bytes.AddRange(Encoding.UTF8.GetBytes("PartyListLayoutRevived"));
            bytes.Add(1);
        ...
        public static bool DeserializeLayout(byte[] bytes, LayoutConfig layoutConfig) {
            ...
            if (Encoding.UTF8.GetString(bytes, 0, 15) != "PartyListLayoutRevived") {
